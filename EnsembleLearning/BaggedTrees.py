...
def Bagged(training_data, columns, T):
    ...
    trees.append(ID3(x_t, columns, None, 0, 20))
...
def Report_2_2_c(_columns, _attribute_values, _attribute_types, _labels, training_data_filepath, test_data_filepath):
    print("Bagged Trees Bias/Var")
...
def Report_2_2_b(_columns, _attribute_values, _attribute_types, _labels, training_data_filepath, test_data_filepath):
    # Get and set the global variables
    global columns
    global attribute_values
    global attribute_types
    ...
    for T in range(1, 501):
        Bagged(training_data, columns[:-1], T)
...
def main():
    if len(sys.argv) == 2:
        if sys.argv[1] == '1':
            Report_2_2_b(bank_columns, bank_attribute_values, bank_attribute_types,
                         bank_labels,  "EnsembleLearning/bank/train.csv", "EnsembleLearning/bank/test.csv")
        elif sys.argv[1] == '2':
            Report_2_2_c(bank_columns, bank_attribute_values, bank_attribute_types,
                         bank_labels,  "EnsembleLearning/bank/train.csv", "EnsembleLearning/bank/test.csv")
        else:
